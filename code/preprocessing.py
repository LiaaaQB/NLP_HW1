...
class FeatureStatistics:
    def __init__(self):
        ...
        feature_dict_list = ["f100", "f101", "f102", "f103", "f104", "f105", "f106", "f107", "f108", "f109", "f110"]  # the feature classes used in the code
        ...
        with open(file_path) as file:
            for line in file:
                ...
                for word_idx in range(len(split_words)):
                    ...
                    known_suffix = [('ful', 'JJ'), ('ish', 'JJ'), ('like', 'JJ'), ('ous', 'JJ'), ('able', 'JJ'),
                    ...
                    for item in known_suffix:
                        suf = item[0]
                        t = item[1]
                        self.feature_rep_dict["f101"][(suf, t)] = 15
    ...
    def cut_down_ft(self):
        modified_threshold = {"f100": 5,
            "f101": 10,
            "f102": 25,
            "f103": 10,
            "f104": 5,
            ...
            "f109": 5,
            "f110": 15}
        for feat_class in self.feature_rep_dict:
            for feat, count in self.feature_rep_dict[feat_class].items():
                if count < modified_threshold[feat_class]:
                    del self.feature_rep_dict[feat_class][feat]
...
class Feature2id:
    ...
    def get_features(self, sentence, i, prev_tag, tag, prev_prev_tag):
        """
        given a sentence, we want to find the features that apply in the feature_to_idx list
        :param sentence:
        :param i:
        :param prev_tag:
        :param tag:
